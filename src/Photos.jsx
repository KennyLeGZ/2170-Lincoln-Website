    ...
    <>
      ...
      <main style={{ padding: '2rem 0', margin: '0', paddingTop: '150px', paddingBottom: '2rem', margin: '0' }}>
        ...
        <div className="photo-description">
          <p>
            Browse through a curated gallery of 2170 Lincoln's beautifully designed apartments. Whether you're looking for a studio, 1-bedroom, or 2-bedroom, each image showcases the bright, modern, and inviting spaces that make this community special.
          </p>
        </div>
